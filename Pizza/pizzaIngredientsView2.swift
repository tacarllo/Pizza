...
class pizzaIngredientsView2: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    
   
    
    @IBOutlet weak var ingredientsPicker2: UIPickerView!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.ingredientsPicker2.dataSource = self;
        self.ingredientsPicker2.delegate = self;
