...
class pizzaIngredientsView: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {

    @IBOutlet weak var ingredientsPicker1: UIPickerView!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.ingredientsPicker1.dataSource = self;
        self.ingredientsPicker1.delegate = self;
