...
class pizzaIngredientsView4: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    
    
    
    @IBOutlet weak var ingredientsPicker4: UIPickerView!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.ingredientsPicker4.dataSource = self;
        self.ingredientsPicker4.delegate = self;
