...
class pizzaIngredientsView3: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    
    
    
    @IBOutlet weak var ingredientsPicker3: UIPickerView!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.ingredientsPicker3.dataSource = self;
        self.ingredientsPicker3.delegate = self;
